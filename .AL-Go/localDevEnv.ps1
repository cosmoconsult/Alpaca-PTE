...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/OleWunschmann/AL-Go/update-workflow-reusable-default-inputs/Actions/Github-Helper.psm1' -folder $tmpFolder -notifyAuthenticatedAttempt
$ReadSettingsModule = DownloadHelperFile -url 'https://raw.githubusercontent.com/OleWunschmann/AL-Go/update-workflow-reusable-default-inputs/Actions/.Modules/ReadSettings.psm1' -folder $tmpFolder
$debugLoggingModule = DownloadHelperFile -url 'https://raw.githubusercontent.com/OleWunschmann/AL-Go/update-workflow-reusable-default-inputs/Actions/.Modules/DebugLogHelper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/OleWunschmann/AL-Go/update-workflow-reusable-default-inputs/Actions/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/OleWunschmann/AL-Go/update-workflow-reusable-default-inputs/Actions/.Modules/settings.schema.json' -folder $tmpFolder | Out-Null
DownloadHelperFile -url 'https://raw.githubusercontent.com/OleWunschmann/AL-Go/update-workflow-reusable-default-inputs/Actions/Environment.Packages.proj' -folder $tmpFolder | Out-Null
